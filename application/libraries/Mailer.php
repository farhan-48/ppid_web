...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'aldagheauly28@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Alda Gheauly'; // Isikan dengan nama pengirim
    protected $password = 'aldacantik27'; // Isikan dengan password email pengirim
